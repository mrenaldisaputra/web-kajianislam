                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-8">
                                            ...
                                            <div class="mt-3 line-clamp">
                                                <?= get_excerpt(strip_html_tags($artikel['deskripsi']), 15); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div data-sticky data-margin-top="80" data-sticky-for="767">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-lg-12">
                                <h4 class="mt-4 mb-3">Artikel Terpopuler</h4>
                                <!-- Recent post item -->
                                <?php foreach ($most_viewed_articles as $key => $article): ?>
                                    <div class="card mb-3">
                                        <div class="row g-3">
                                            <div class="col-4 p-12">
                                                <img class="image-cover-most"
                                                    src="<?= base_url('assets/img/artikel/') . (($article['gambar'] === 'no_image.png') ? $article['gambar'] : $article['gambar']) ?>"
                                                    alt="">
                                            </div>
                                            <div class="col-8">
                                                <h6><a href="<?= base_url('portal/artikel/') . $article['id'] ?>"
                                                        class="btn-link stretched-link text-reset fw-bold"><?php echo $article['judul']; ?></a>
                                                </h6>
