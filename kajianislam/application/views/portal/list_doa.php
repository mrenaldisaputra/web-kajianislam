                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 pb-3">
                                    <div class="mb-4 d-md-flex justify-content-between align-items-center">
                                        <h2 class="m-0"><i class="bi bi-caret-right-fill"></i></i> Pilihan Doa</h2>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card mb-3 mb-sm-4">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-8">
                                            ...
                                            <h4><a href="<?= base_url('portal/doa/') . $doa['id'] ?>"
                                            ...
                                            <div class="mt-3 line-clamp">
                                                <?= get_excerpt(strip_html_tags($doa['deskripsi']), 15); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div data-sticky data-margin-top="80" data-sticky-for="767">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-lg-12">
                                <h4 class="mt-4 mb-3">Doa Terpopuler</h4>
                                <!-- Recent post item -->
                                <?php foreach ($most_viewed_doa as $key => $doas): ?>
                                    <div class="card mb-3">
                                        <div class="row g-3">
                                            <div class="col-4 p-12">
                                                <img class="image-cover-most"
                                                    src="<?= base_url('assets/img/doa/') . (($doas['gambar'] === 'no_image.png') ? $doas['gambar'] : $doas['gambar']) ?>"
                                                    alt="">
                                            </div>
                                            <div class="col-8">
                                                <h6><a href="<?= base_url('portal/doa/') . $doas['id'] ?>"
                                                        class="btn-link stretched-link text-reset fw-bold"><?php echo $doas['judul']; ?></a>
                                                </h6>
