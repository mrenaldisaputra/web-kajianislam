...
<head>
    ...
    <style>
        ...
        .cover-carousel {
            ...
            height: 75vh;
            /* Menyesuaikan tinggi dengan tinggi viewport */
        }

        .cover-carousel .carousel-item {
            overflow: hidden;
            /* Memastikan pemangkasan gambar */
        }

        .cover-carousel .carousel-item img {
            object-fit: cover;
            /* Memastikan gambar memenuhi area carousel */
            height: 720px;
            /* Memastikan tinggi gambar sesuai dengan carousel */
            width: auto;
            /* Memastikan lebar gambar sesuai dengan carousel */
        }
    </style>
