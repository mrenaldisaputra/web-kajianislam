<!-- Ini adalah view yang sama dengan new_video.php -->
<section class="py-4">
    <div class="container">
        <div class="row pb-4">
            <div class="col-12">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card border">
                    <!-- Card body -->
                    <div class="card-body">
                        <?php echo form_open('video/edit_video/' . $video['id'], ['id' => 'myForm', 'enctype' => 'multipart/form-data']); ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="short_description" name="short_description"
                                rows="3"><?= $video['deskripsi']; ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="post_date" name="post_date"
                                value="<?= datetime_to_local($video['tanggal']); ?>">
                            <?= form_error('post_date', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>

                        <div class="form-group">
                            <label for="isi_artikel">Isi Video</label>
                            ...
                            <input type="hidden" name="isi_artikel" value="<?= $video['isi']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <img id="preview" src="<?= base_url('assets/img/video/') . $video['gambar']; ?>"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="id_kategori" name="id_kategori">
                                ...
                                <?php foreach ($categories as $category): ?>
                                    <option value="<?= $category['id']; ?>" <?= $category['id'] == $video['id_kategori'] ? 'selected' : ''; ?>>
                                        <?= $category['nama']; ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="status" name="status">
                                <option value="Aktif" <?= $video['status'] == 'Aktif' ? 'selected' : ''; ?>>Aktif
                                </option>
                                <option value="Nonaktif" <?= $video['status'] == 'Nonaktif' ? 'selected' : ''; ?>>
                                    Nonaktif</option>
                            </select>
