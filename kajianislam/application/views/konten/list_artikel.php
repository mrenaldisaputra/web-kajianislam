...
<div class="container-fluid">
    ...
    <div class="mb-3">
        <a href="<?= base_url('artikel/new_artikel') ?>" class="btn btn-success">
            ...
            <div class="table-responsive">
                <table id="table2" class="table table-bordered table-striped" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        foreach ($list_artikel as $artikel): // Mulai loop untuk setiap baris data 
                            ?>
                            <tr>
    ...
    <?php foreach ($list_artikel as $artikel) { ?>
        <div class="modal fade" id="deleteArtikel<?= $artikel['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary btn-delete-artikel"
                            data-artikel-id="<?= $artikel['id'] ?>">Hapus
                        </button>
