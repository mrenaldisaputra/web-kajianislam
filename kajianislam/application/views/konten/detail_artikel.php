        ...
        <div class="col-lg-8">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class=" form-group">
                        <label>ID</label>
                        <input type="text" class="form-control col-1" value="<?= $artikel['id']; ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label>Judul</label>
                        <input type="text" class="form-control" value="<?= $artikel['judul']; ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label>Deskripsi Singkat</label>
                        <textarea class="form-control" rows="3" readonly><?= $artikel['deskripsi']; ?></textarea>
                    </div>
                    <div class="form-group">
                        <label>Nama Penulis</label>
                        <input type="text" class="form-control col-7" value="<?= $artikel['nama_penulis']; ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label>Tanggal</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?= $artikel['urlvideo']; ?>" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control col-3" value="<?= $artikel['status']; ?>" readonly>
                    </div>

                    <div>
                        <a class="btn btn-secondary" type="button"
                            href=" <?= base_url('artikel/list_artikel') ?>">Cancel</a>
