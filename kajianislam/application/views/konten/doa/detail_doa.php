        ...
        <div class="col-lg-8">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class=" form-group">
                        <label>ID</label>
                        <input type="text" class="form-control col-1" value="<?= $doa['id']; ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label>Judul</label>
                        <input type="text" class="form-control" value="<?= $doa['judul']; ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label>Deskripsi Singkat</label>
                        <textarea class="form-control" rows="3" readonly><?= $doa['deskripsi']; ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="nama_penulis">Nama Penulis</label>
                        <input type="text" class="form-control" id="nama_penulis" name="nama_penulis"
                            value="<?= $doa['nama_penulis']; ?>" readonly>
                        <?= form_error('nama_penulis', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>

                    <div class="form-group">
                        <label>Tanggal</label>
                        <input type="datatime-local" id="post_date" class="form-control col-4"
                            value="<?php
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-control" contenteditable="false" style="min-height: 500px; overflow-y: auto;">
                            <?= htmlspecialchars_decode($doa['isi']); ?>
                        </div>
                    </div>

                    <div class="form-group">
                        <label>URL doa</label>
                        <input type="text" class="form-control" value="<?= $doa['urlvideo']; ?>" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control col-3" value="<?= $doa['status']; ?>" readonly>
                    </div>

                    <div>
                        <a class="btn btn-secondary" type="button" href=" <?= base_url('doa/list_doa') ?>">Cancel</a>
