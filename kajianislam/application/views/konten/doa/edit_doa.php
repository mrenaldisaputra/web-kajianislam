<!-- Ini adalah view yang sama dengan new_doa.php -->
<section class="py-4">
    <div class="container">
        <div class="row pb-4">
            <div class="col-12">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card border">
                    <!-- Card body -->
                    <div class="card-body">
                        <?php echo form_open('doa/edit_doa/' . $doa['id'], ['id' => 'myForm', 'enctype' => 'multipart/form-data']); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="post_date" name="post_date"
                                value="<?= datetime_to_local($doa['tanggal']); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="isi_artikel" value="<?= $doa['isi']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <img id="preview" src="<?= base_url('assets/img/doa/') . $doa['gambar']; ?>"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="id_kategori" name="id_kategori">
                                ...
                                <?php foreach ($categories as $category): ?>
                                    <option value="<?= $category['id']; ?>" <?= $category['id'] == $doa['id_kategori'] ? 'selected' : ''; ?>>
                                        <?= $category['nama']; ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="status" name="status">
                                <option value="Aktif" <?= $doa['status'] == 'Aktif' ? 'selected' : ''; ?>>Aktif
                                </option>
                                <option value="Nonaktif" <?= $doa['status'] == 'Nonaktif' ? 'selected' : ''; ?>>
                                    Nonaktif</option>
                            </select>
